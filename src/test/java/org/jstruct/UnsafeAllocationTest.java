...
@Test
public class UnsafeAllocationTest
{
...
//        }
        ...
        try {
            ...
            for (int i = BYTE_BYTES; i >= -1; i--) {
                try {
                    ...
                    if (i != BYTE_BYTES) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == BYTE_BYTES) fail("Unxpected IndexOutOfBoundsException " + i);
                }
                try {
            ...
            for (int i = SHORT_BYTES; i >= -1; i--) {
                try {
                    ...
                    if (i != SHORT_BYTES) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == SHORT_BYTES) fail("Unxpected IndexOutOfBoundsException " + i);
                }
                try {
            ...
            for (int i = CHAR_BYTES; i >= -1; i--) {
                try {
                    ...
                    if (i != CHAR_BYTES) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == CHAR_BYTES) fail("Unxpected IndexOutOfBoundsException " + i);
                }
                try {
            ...
            for (int i = INT_BYTES; i >= -1; i--) {
                try {
                    ...
                    if (i != INT_BYTES) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == INT_BYTES) fail("Unxpected IndexOutOfBoundsException " + i);
                }
                try {
            ...
            for (int i = LONG_BYTES; i >= -1; i--) {
                try {
                    ...
                    if (i != LONG_BYTES) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == LONG_BYTES) fail("Unxpected IndexOutOfBoundsException " + i);
                }
                try {
            ...
            for (int i = FLOAT_BYTES; i >= -1; i--) {
                try {
                    ...
                    if (i != FLOAT_BYTES) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == FLOAT_BYTES) fail("Unxpected IndexOutOfBoundsException " + i);
                }
                try {
            ...
            for (int i = DOUBLE_BYTES; i >= -1; i--) {
                try {
                    ...
                    if (i != DOUBLE_BYTES) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == DOUBLE_BYTES) fail("Unxpected IndexOutOfBoundsException " + i);
                }
                try {
            ...
            for (int i = bytes.length; i >= -1; i--) {
                ...
                try {
                    ...
                    if (i != bytes.length) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == bytes.length) fail("Unxpected IndexOutOfBoundsException " + i);
                }
            ...
            for (int i = partialSize; i >= -1; i--) {
                ...
                try {
                    ...
                    if (i != partialSize) fail("Expected IndexOutOfBoundsException " + i);
                } catch (IndexOutOfBoundsException expected) {
                    if (i == partialSize) fail("Unxpected IndexOutOfBoundsException " + i);
                }
    ...
    public void testCopyMemory() {
        ...
        try {
            ...
            pointer.free();
            if (otherUnsafeMemory != null) otherUnsafeMemory.free();
        }
    }
}