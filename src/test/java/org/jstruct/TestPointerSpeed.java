...
//        speed.testDirectBuffer();
    ...
    private void testPointer() throws Exception {
        long writeGB = 0;
        long writeMB = 0;
        long writeKB = 0;
        long readGB = 0;
        ...
        try {
            for (int loops = 0; loops < 20; loops++) {
                ...
                try {
                    ...
                    if (loops > 10) writeGB += elapsedTime;
                ...
                try {
                    ...
                    long elapsedTime = System.nanoTime() - startTime;
                    if (loops > 10) writeMB += elapsedTime;
                ...
                try {
                    ...
                    long elapsedTime = System.nanoTime() - startTime;
                    if (loops > 10) writeKB += elapsedTime;
                ...
                try {
                    ...
                    long elapsedTime = System.nanoTime() - startTime;
                    if (loops > 10) readGB += elapsedTime;
                ...
                try {
                    ...
                    long elapsedTime = System.nanoTime() - startTime;
                    if (loops > 10) readMB += elapsedTime;
                ...
                try {
                    ...
                    long elapsedTime = System.nanoTime() - startTime;
                    if (loops > 10) readKB += elapsedTime;
    ...
    private void testDirectBuffer() throws Exception {
        long writeGB = 0;
        long writeMB = 0;
        long writeKB = 0;
        long readGB = 0;
    ...
    private void testByteArray() throws Exception {
        long writeGB = 0;
        long writeMB = 0;
        long writeKB = 0;
        long readGB = 0;
